...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=22&duration=3000&pause=1000&color=8B5CF6&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=100&lines=C%C3%B3digo+con+prop%C3%B3sito.;Frontend+%7C+Backend+%7C+Cloud+%7C+AI+%7C+Automation;Creating+intelligent+software+that+matters." />
...
const carlos: Developer = {
  languages: ["TypeScript", "JavaScript", "Python", "Java", "C#", "PHP", "Kotlin", "Dart", "Swift"],
  currentFocus: ["AI Integration", "Cloud Architecture", "Developer Experience"],
  philosophy: "El buen código es poesía. La automatización es libertad.",
  FunFact: () => "I automate everything — even the automations 🤖",
};
```

I'm a **Full Stack Developer** who doesn't just write code — I architect systems, automate workflows, integrate AI into real products, and craft interfaces that feel right. From backend pipelines to the last pixel on screen, I build complete solutions that generate real impact.
...
### ✍️ _"El buen código es poesía. La automatización es libertad."_

<br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:10B981,50:3B82F6,100:8B5CF6&height=120&section=footer" />
